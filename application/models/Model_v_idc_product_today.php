...
class Model_v_idc_product_today extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'v_idc_product_today';
	...
	public function __construct()
	{
		...
		public function select_string() {
			$select_string = '';
						$select_string .= "v_idc_product_today.*";
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "v_idc_product_today.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " v_idc_product_today.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_v_idc_product_today.php */
/* Location: ./application/models/Model_v_idc_product_today.php */
