...
class Model_events extends MY_Model {
	...
	private $field_search 	= ['event_image', 'event_name', 'event_type', 'check_in_date', 'check_out_date'];
	private $user_restriction = '';
	private $field_search_type = array("event_image" => "file","event_name" => "input","event_type" => "input","event_location" => "input","check_in_date" => "timestamp","check_out_date" => "timestamp");
