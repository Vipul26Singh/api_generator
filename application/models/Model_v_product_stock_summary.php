...
class Model_v_product_stock_summary extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'v_product_stock_summary';
	private $field_search 	= ['product_name', 'quantity', 'load_cycle'];
	private $user_restriction = '';
	private $field_search_type = array("product_name" => "input","quantity" => "input","load_cycle" => "input");
	...
	public function __construct()
	{
		...
		public function select_string() {
			$select_string = '';
						$select_string .= "v_product_stock_summary.*";
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "v_product_stock_summary.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " v_product_stock_summary.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_v_product_stock_summary.php */
/* Location: ./application/models/Model_v_product_stock_summary.php */
