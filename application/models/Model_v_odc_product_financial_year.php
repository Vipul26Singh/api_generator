...
class Model_v_odc_product_financial_year extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'v_odc_product_financial_year';
	...
	public function __construct()
	{
		...
		public function select_string() {
			$select_string = '';
						$select_string .= "v_odc_product_financial_year.*";
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "v_odc_product_financial_year.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " v_odc_product_financial_year.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_v_odc_product_financial_year.php */
/* Location: ./application/models/Model_v_odc_product_financial_year.php */
