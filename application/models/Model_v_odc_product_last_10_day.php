...
class Model_v_odc_product_last_10_day extends MY_Model {

	private $primary_key    = NULL;
	private $table_name 	= 'v_odc_product_last_10_day';
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (empty($field)) {
			foreach ($this->field_search as $field) {
				if ($iterasi == 1) {
					$where .= "v_odc_product_last_10_day.".$field . " LIKE '%" . $q . "%' ";
				} else {
					$where .= "OR " . "v_odc_product_last_10_day.".$field . " LIKE '%" . $q . "%' ";
				}
				$iterasi++;
			}
...
/* End of file Model_v_odc_product_last_10_day.php */
/* Location: ./application/models/Model_v_odc_product_last_10_day.php */
