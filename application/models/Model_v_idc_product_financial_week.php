...
class Model_v_idc_product_financial_week extends MY_Model {

	private $primary_key    = NULL;
	private $table_name 	= 'v_idc_product_financial_week';
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (empty($field)) {
			foreach ($this->field_search as $field) {
				if ($iterasi == 1) {
					$where .= "v_idc_product_financial_week.".$field . " LIKE '%" . $q . "%' ";
				} else {
					$where .= "OR " . "v_idc_product_financial_week.".$field . " LIKE '%" . $q . "%' ";
				}
				$iterasi++;
			}
...
/* End of file Model_v_idc_product_financial_week.php */
/* Location: ./application/models/Model_v_idc_product_financial_week.php */
