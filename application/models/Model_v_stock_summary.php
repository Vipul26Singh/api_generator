...
class Model_v_stock_summary extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'v_stock_summary';
	private $field_search 	= ['name', 'quantity'];
	private $user_restriction = '';
	private $field_search_type = array("name" => "input","quantity" => "input");
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "v_stock_summary.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " v_stock_summary.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_v_stock_summary.php */
/* Location: ./application/models/Model_v_stock_summary.php */
