...
class Model_v_odc_product_financial_month extends MY_Model {

	private $primary_key    = NULL;
	private $table_name 	= 'v_odc_product_financial_month';
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (empty($field)) {
			foreach ($this->field_search as $field) {
				if ($iterasi == 1) {
					$where .= "v_odc_product_financial_month.".$field . " LIKE '%" . $q . "%' ";
				} else {
					$where .= "OR " . "v_odc_product_financial_month.".$field . " LIKE '%" . $q . "%' ";
				}
				$iterasi++;
			}
...
/* End of file Model_v_odc_product_financial_month.php */
/* Location: ./application/models/Model_v_odc_product_financial_month.php */
