...
class Model_v_odc_product_week extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'v_odc_product_week';
	...
	public function __construct()
	{
		...
		public function select_string() {
			$select_string = '';
						$select_string .= "v_odc_product_week.*";
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "v_odc_product_week.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " v_odc_product_week.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_v_odc_product_week.php */
/* Location: ./application/models/Model_v_odc_product_week.php */
