                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Events</h5>
                            <hr>
                        </div>
		          ...
		          <div class="widget-user-header ">
                        ...
                        <?= form_open(base_url('administrator/events/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_events', 
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="events_event_image_uuid" id="events_event_image_uuid" type="hidden" value="<?= set_value('events_event_image_uuid'); ?>">
                                <input class="data_file" name="events_event_image_name" id="events_event_image_name" type="hidden" value="<?= set_value('events_event_image_name', $events->event_image); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="event_name" id="event_name" placeholder="Event Name" value="<?= set_value('event_name', $events->event_name); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="event_type" id="event_type" placeholder="Event Type" value="<?= set_value('event_type', $events->event_type); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="event_location" id="event_location" placeholder="Event Location" value="<?= set_value('event_location', $events->event_location); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#events_image_galery').find('li').attr('qq-file-id');
       ...
       $('#events_event_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/events/get_event_image_file/<?= $events->id; ?>',
